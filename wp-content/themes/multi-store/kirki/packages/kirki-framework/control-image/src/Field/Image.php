	...
	public function filter_control_args( $args, $wp_customize ) {
		if ( $args['settings'] === $this->args['settings'] ) {
			...
			$args['button_labels'] = wp_parse_args(
				$args['button_labels'],
				[
					'select'       => esc_html__( 'Select image', 'multi-store' ),
					'change'       => esc_html__( 'Change image', 'multi-store' ),
					'default'      => esc_html__( 'Default', 'multi-store' ),
					'remove'       => esc_html__( 'Remove', 'multi-store' ),
					'placeholder'  => esc_html__( 'No image selected', 'multi-store' ),
					'frame_title'  => esc_html__( 'Select image', 'multi-store' ),
					'frame_button' => esc_html__( 'Choose image', 'multi-store' ),
				]
			);
