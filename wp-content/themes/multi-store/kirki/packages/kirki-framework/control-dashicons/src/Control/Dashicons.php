		...
		<div class="icons-wrapper">
			...
			<# } else { #>
				...
				var dashiconSections = {
					'admin-menu': '<?php esc_html_e( 'Admin Menu', 'multi-store' ); ?>',
					'welcome-screen': '<?php esc_html_e( 'Welcome Screen', 'multi-store' ); ?>',
					'post-formats': '<?php esc_html_e( 'Post Formats', 'multi-store' ); ?>',
					'media': '<?php esc_html_e( 'Media', 'multi-store' ); ?>',
					'image-editing': '<?php esc_html_e( 'Image Editing', 'multi-store' ); ?>',
					'tinymce': 'TinyMCE',
					'posts': '<?php esc_html_e( 'Posts', 'multi-store' ); ?>',
					'sorting': '<?php esc_html_e( 'Sorting', 'multi-store' ); ?>',
					'social': '<?php esc_html_e( 'Social', 'multi-store' ); ?>',
					'wordpress_org': 'WordPress',
					'products': '<?php esc_html_e( 'Products', 'multi-store' ); ?>',
					'taxonomies': '<?php esc_html_e( 'Taxonomies', 'multi-store' ); ?>',
					'widgets': '<?php esc_html_e( 'Widgets', 'multi-store' ); ?>',
					'notifications': '<?php esc_html_e( 'Notifications', 'multi-store' ); ?>',
					'misc': '<?php esc_html_e( 'Miscelaneous', 'multi-store' ); ?>'
				};
				#>
