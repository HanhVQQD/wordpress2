...
class ReactSelect extends Base {
	...
	public function to_json() {
		...
		$this->json['placeholder'] = ( $this->placeholder ) ? $this->placeholder : esc_html__( 'Select...', 'multi-store' );
		...
		$this->json['messages'] = [
			...
			'maxLimitReached' => sprintf( esc_html__( 'You can only select %s items', 'multi-store' ), $this->max_selection_number ),
		];
