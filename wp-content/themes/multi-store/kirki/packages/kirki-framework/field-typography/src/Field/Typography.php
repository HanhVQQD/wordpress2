...
class Typography extends Field {
	...
	public function init( $args = [] ) {
		...
		self::$std_variants = [
			[
				'value' => 'regular',
				'label' => __( 'Regular', 'multi-store' ),
			],
			[
				'value' => 'italic',
				'label' => __( 'Italic', 'multi-store' ),
			],
			[
				'value' => '700',
				'label' => __( '700', 'multi-store' ),
			],
			[
				'value' => '700italic',
				'label' => __( '700 Italic', 'multi-store' ),
			],
		];
		...
		self::$complete_variants = [
			...
			[
				'value' => '100',
				'label' => __( '100', 'multi-store' ),
			],
			[
				'value' => '100italic',
				'label' => __( '100 Italic', 'multi-store' ),
			],
			[
				'value' => '200',
				'label' => __( '200', 'multi-store' ),
			],
			[
				'value' => '200italic',
				'label' => __( '200 Italic', 'multi-store' ),
			],
			[
				'value' => '300',
				'label' => __( '300', 'multi-store' ),
			],
			[
				'value' => '300italic',
				'label' => __( '300 Italic', 'multi-store' ),
			],
			[
				'value' => '500',
				'label' => __( '500', 'multi-store' ),
			],
			[
				'value' => '500italic',
				'label' => __( '500 Italic', 'multi-store' ),
			],
			[
				'value' => '600',
				'label' => __( '600', 'multi-store' ),
			],
			[
				'value' => '600italic',
				'label' => __( '600 Italic', 'multi-store' ),
			],
			[
				'value' => '700',
				'label' => __( '700', 'multi-store' ),
			...
			[
				'value' => '800',
				'label' => __( '800', 'multi-store' ),
			],
			[
				'value' => '800italic',
				'label' => __( '800 Italic', 'multi-store' ),
			],
			[
				'value' => '900',
				'label' => __( '900', 'multi-store' ),
			],
			[
				'value' => '900italic',
				'label' => __( '900 Italic', 'multi-store' ),
			],
		];
	...
	private function add_sub_fields( $args ) {
		...
		if ( isset( $args['default']['font-family'] ) ) {
			...
			new \Kirki\Field\ReactSelect(
				wp_parse_args(
					[
						'label'       => esc_html__( 'Font Family', 'multi-store' ),
						'description' => '',
			...
			new \Kirki\Field\ReactSelect(
				wp_parse_args(
					[
						'label'       => esc_html__( 'Font Variant', 'multi-store' ),
						'description' => '',
		...
		if ( $font_size_field_specified || $color_field_specified ) {
			$group = [
				'font-size' => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Font Size', 'multi-store' ),
					'is_specified' => $font_size_field_specified,
				],
				'color'     => [
					'type'         => 'react-colorful',
					'label'        => esc_html__( 'Font Color', 'multi-store' ),
		...
		if ( $text_align_field_specified || $text_transform_field_specified ) {
			$group = [
				'text-align'     => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Align', 'multi-store' ),
					'is_specified' => $text_align_field_specified,
					'choices'      => [
						'initial' => esc_html__( 'Initial', 'multi-store' ),
						'left'    => esc_html__( 'Left', 'multi-store' ),
						'center'  => esc_html__( 'Center', 'multi-store' ),
						'right'   => esc_html__( 'Right', 'multi-store' ),
						'justify' => esc_html__( 'Justify', 'multi-store' ),
					],
				],
				'text-transform' => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Transform', 'multi-store' ),
					'is_specified' => $text_transform_field_specified,
					'choices'      => [
						'none'       => esc_html__( 'None', 'multi-store' ),
						'capitalize' => esc_html__( 'Capitalize', 'multi-store' ),
						'uppercase'  => esc_html__( 'Uppercase', 'multi-store' ),
						'lowercase'  => esc_html__( 'Lowercase', 'multi-store' ),
					],
				],
			];
		...
		if ( $text_decoration_field_specified ) {
			$group = [
				'text-decoration' => [
					'type'         => 'react-select',
					'label'        => esc_html__( 'Text Decoration', 'multi-store' ),
					'is_specified' => $text_decoration_field_specified,
					'choices'      => [
						'none'         => esc_html__( 'None', 'multi-store' ),
						'underline'    => esc_html__( 'Underline', 'multi-store' ),
						'line-through' => esc_html__( 'Line Through', 'multi-store' ),
						'overline'     => esc_html__( 'Overline', 'multi-store' ),
						'solid'        => esc_html__( 'Solid', 'multi-store' ),
						'wavy'         => esc_html__( 'Wavy', 'multi-store' ),
					],
				],
			];
		...
		if ( $line_height_field_specified || $letter_spacing_field_specified ) {
			$group = [
				'line-height'    => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Line Height', 'multi-store' ),
					'is_specified' => $line_height_field_specified,
				],
				'letter-spacing' => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Letter Spacing', 'multi-store' ),
		...
		if ( $margin_top_field_specified || $margin_bottom_field_specified ) {
			$group = [
				'margin-top'    => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Margin Top', 'multi-store' ),
					'is_specified' => $margin_top_field_specified,
				],
				'margin-bottom' => [
					'type'         => 'dimension',
					'label'        => esc_html__( 'Margin Bottom', 'multi-store' ),
	...
	private function get_font_family_choices() {
		...
		$choices['default'] = [
			esc_html__( 'Defaults', 'multi-store' ),
			[
				'' => esc_html__( 'Default', 'multi-store' ),
			],
		];
		...
		$choices['standard'] = [
			esc_html__( 'Standard Fonts', 'multi-store' ),
			$std_fonts,
		];

		$choices['google'] = [
			esc_html__( 'Google Fonts', 'multi-store' ),
