...
class Dimensions extends Field {
	...
	public function init( $args = array() ) {
		...
		$labels = array(
			...
			'font-size'      => esc_html__( 'Font Size', 'multi-store' ),
			'font-weight'    => esc_html__( 'Font Weight', 'multi-store' ),
			'line-height'    => esc_html__( 'Line Height', 'multi-store' ),
			'font-style'     => esc_html__( 'Font Style', 'multi-store' ),
			'letter-spacing' => esc_html__( 'Letter Spacing', 'multi-store' ),
			'word-spacing'   => esc_html__( 'Word Spacing', 'multi-store' ),
			'top'            => esc_html__( 'Top', 'multi-store' ),
			'bottom'         => esc_html__( 'Bottom', 'multi-store' ),
			'left'           => esc_html__( 'Left', 'multi-store' ),
			'right'          => esc_html__( 'Right', 'multi-store' ),
			'center'         => esc_html__( 'Center', 'multi-store' ),
			'size'           => esc_html__( 'Size', 'multi-store' ),
			'spacing'        => esc_html__( 'Spacing', 'multi-store' ),
			'width'          => esc_html__( 'Width', 'multi-store' ),
			'height'         => esc_html__( 'Height', 'multi-store' ),
			'invalid-value'  => esc_html__( 'Invalid Value', 'multi-store' ),
		);
