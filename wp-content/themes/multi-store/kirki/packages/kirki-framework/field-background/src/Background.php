		...
		new \Kirki\Field\Color(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Color', 'multi-store' ),
		...
		new \Kirki\Field\Image(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Image', 'multi-store' ),
		...
		new Kirki\Field\Select(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Repeat', 'multi-store' ),
					'section'     => $args['section'],
					'default'     => isset( $args['default']['background-repeat'] ) ? $args['default']['background-repeat'] : '',
					'choices'     => [
						'no-repeat' => esc_html__( 'No Repeat', 'multi-store' ),
						'repeat'    => esc_html__( 'Repeat All', 'multi-store' ),
						'repeat-x'  => esc_html__( 'Repeat Horizontally', 'multi-store' ),
						'repeat-y'  => esc_html__( 'Repeat Vertically', 'multi-store' ),
					],
		...
		new Kirki\Field\Select(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Position', 'multi-store' ),
					'default'     => isset( $args['default']['background-position'] ) ? $args['default']['background-position'] : '',
					'section'     => $args['section'],
					'choices'     => [
						'left top'      => esc_html__( 'Left Top', 'multi-store' ),
						'left center'   => esc_html__( 'Left Center', 'multi-store' ),
						'left bottom'   => esc_html__( 'Left Bottom', 'multi-store' ),
						'center top'    => esc_html__( 'Center Top', 'multi-store' ),
						'center center' => esc_html__( 'Center Center', 'multi-store' ),
						'center bottom' => esc_html__( 'Center Bottom', 'multi-store' ),
						'right top'     => esc_html__( 'Right Top', 'multi-store' ),
						'right center'  => esc_html__( 'Right Center', 'multi-store' ),
						'right bottom'  => esc_html__( 'Right Bottom', 'multi-store' ),
					],
					'required'    => array_merge(
						$args['required'],
						[
		...
		new Kirki\Field\Radio_Buttonset(
			wp_parse_args(
				[
					...
					'label'       => '',
					'description' => esc_html__( 'Background Size', 'multi-store' ),
					'default'     => isset( $args['default']['background-size'] ) ? $args['default']['background-size'] : '',
					'section'     => $args['section'],
					'choices'     => [
						'cover'   => esc_html__( 'Cover', 'multi-store' ),
						'contain' => esc_html__( 'Contain', 'multi-store' ),
						'auto'    => esc_html__( 'Auto', 'multi-store' ),
					],
					'required'    => array_merge(
						$args['required'],
						[
		...
		new Kirki\Field\Radio_Buttonset(
			wp_parse_args(
				[
					...
					'description' => esc_html__( 'Background Attachment', 'multi-store' ),
					'label'       => '',
					'default'     => isset( $args['default']['background-attachment'] ) ? $args['default']['background-attachment'] : '',
					'section'     => $args['section'],
					'choices'     => [
						'scroll' => esc_html__( 'Scroll', 'multi-store' ),
						'fixed'  => esc_html__( 'Fixed', 'multi-store' ),
					],
					'required'    => array_merge(
						$args['required'],
						[
